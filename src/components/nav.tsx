...
const navigation = [
  { name: "Lucky Draw", href: "/", current: true },
        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex w-screen flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current
                            ? " border-4 border-blue-500 text-white hover:bg-blue-500"
                            : " border-4 border-blue-500 text-white hover:bg-blue-500 hover:text-white",
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <Link
                  type="button"
                  className="rounded-md border-4 border-white bg-blue-500 p-2 text-white"
                  href={"wallet"}
                >
