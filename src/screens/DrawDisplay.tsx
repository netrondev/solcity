      ...
      {draw.is_open && (
        <div>
          <div className="mx-auto mt-16 max-w-2xl text-center">
            ...
            <div className=" text-4xl font-bold text-gray-900 dark:text-white sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl">
                  ...
                  <div className="lg:max-w-lg">
                    ...
                    <div className="h-max rounded-2xl bg-sky-950 p-5">
                      <div className=" items-center gap-1">
                        ...
                        />
                        <div className="mx-auto mt-5 flex flex-row items-center gap-2 sm:gap-2 md:gap-3 lg:gap-4 xl:gap-6">
                          <button
                            className="rounded-xl border border-white bg-blue-900 p-2 pl-3 pr-3 text-xs text-white hover:border-none hover:bg-blue-400"
                            ...
                            onClick={() => {
                              ...
                              setEnterSol(
                                balance.data?.lamports - fee.data.fee
                              );
                            }}
                          >
                            MAX
                          ...
                          <button
                            className=" rounded-xl border border-white bg-blue-700 p-2 pl-3 pr-3 text-xs text-white hover:border-none hover:bg-blue-400"
                            disabled={
